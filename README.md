...
`sh <(curl -L https://github.com/berockguo/go-vim/raw/master/utils/install.sh)`

2. or via `wget`:

`sh <(wget --no-check-certificate https://github.com/berockguo/go-vim/raw/master/utils/install.sh -O -)`
